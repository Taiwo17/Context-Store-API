      ...
      <div className={styles.container}>
        ...
        <div className={styles.product_container}>
          <div className={styles.product_tag}>
            <p className={styles.price_text}>Product</p>
          </div>
          <div className={styles.price_container}>
            <p className={styles.price_text}>Price</p>
            <p className={styles.price_text}>Quantity</p>
            <p className={styles.price_text}>Total</p>
          </div>
        </div>
        {cart?.map((product) => {
          const { id, img, price, priceTitle, quantity } = product
          return (
            <div className={styles.cart_items} key={id}>
              <div className={styles.first_items_section}>
                <div className={styles.img_section}>
                  <img src={img} alt='' />
                  <p className={styles.price_items}>{priceTitle}</p>
                </div>
              </div>
              <div className={styles.second_items_section}>
                <p className={styles.price_items}>${price}</p>
                ...
                <p className={styles.price_items}> {getTotal().totalPrice} </p>
              </div>
            </div>
          )
        })}
