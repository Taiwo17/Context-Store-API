...
function Product() {
  ...
  const products = [
    {
      id: 1,
      img: '/images/panwine/Rectangle 50.png',
      title: 'Amarone',
      price: 12400,
      quantity: 1,
    ...
    <>
      ...
      <div className={styles.container}>
        {products.map((product) => {
          const { id, img, title, price, btnTitle, quantity } = product
          return (
            <div key={id}>
              <div>
                <img className={styles.img} src={img} alt='Product display' />
              </div>
              <div className={styles.title_container}>
              ...
              <div className={styles.btn_container}>
                <button
                  onClick={() =>
                    dispatch(addToCart({ id, img, price, title, quantity }))
                  }
